            ...
            <div class="bg-gray-900">
                <div class="mx-auto flex h-10 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
                    ...
                    <div class="flex items-center space-x-6">
                        <a href="{{ route('login') }}" class="text-sm font-medium text-white hover:text-gray-100">Sign
                            in</a>
                        ...
                        <div class="flex h-16 items-center justify-between">
                            ...
                            <div class="hidden h-full lg:flex">
                                ...
                                <div class="inset-x-0 bottom-0 px-4" x-data="Components.popoverGroup()" x-init="init()">
                                    <div class="flex h-full justify-center space-x-8">
                                        <div class="flex" x-data="Components.popover({ open: true, focus: false })" x-init="init()"
                                            ...
                                            <div class="relative flex">
                                                <button type="button" x-state:on="Item active"
                                                    ...
                                                    aria-expanded="false"
                                                    :aria-expanded="open.toString()">Women</button>
                                            </div>
                                        ...
                                        <div class="flex" x-data="Components.popover({ open: false, focus: false })" x-init="init()"
                                            ...
                                            <div class="relative flex">
                                                <button type="button" x-state:on="Item active"
                                                    ...
                                                    @click="toggle" @mousedown="if (open) $event.preventDefault()"
                                                    aria-expanded="false" :aria-expanded="open.toString()">Men</button>
                                            </div>
                            ...
                            <div class="flex flex-1 items-center lg:hidden">
                                <button type="button"
                                    ...
                                    class="-ml-2 rounded-md bg-white p-2 text-gray-400" @click="open = true">
