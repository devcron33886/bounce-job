    ...
    <div class="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
        <div
            ...
            <div class="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                ...
                <p class="mt-6 text-xl leading-8 text-gray-600">Quasi est quaerat. Sit molestiae et. Provident ad dolorem
                    occaecati eos iste. Soluta rerum quidem minus ut molestiae velit error quod. Excepturi quidem
                    expedita molestias quas.</p>
                ...
                <div class="mt-10 flex">
                    <a href="#"
                        ...
                        our team <span aria-hidden="true">→</span></a>
                </div>
            </div>
